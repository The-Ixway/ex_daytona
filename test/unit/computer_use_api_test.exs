defmodule ExDaytona.Api.ComputerUseTest do
  ...
  # Add tests for each operation in ExDaytona.Api.ComputerUse, for example:
  #
  #   test "lists things", %{bypass: bypass, conn: conn} do
  #     MockServer.expect_get(bypass, "/things", 200, %{things: []})
  #     assert {:ok, _response} = ComputerUse.list_things(conn)
  #   end

  test "module is generated and loaded" do
    assert Code.ensure_loaded?(ComputerUse)
  end
end
