defmodule ExDaytona.Api.PortTest do
  ...
  # Add tests for each operation in ExDaytona.Api.Port, for example:
  #
  #   test "lists things", %{bypass: bypass, conn: conn} do
  #     MockServer.expect_get(bypass, "/things", 200, %{things: []})
  #     assert {:ok, _response} = Port.list_things(conn)
  #   end

  test "module is generated and loaded" do
    assert Code.ensure_loaded?(Port)
  end
end
