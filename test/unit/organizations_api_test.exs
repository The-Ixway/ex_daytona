defmodule ExDaytona.Api.OrganizationsTest do
  ...
  # Add tests for each operation in ExDaytona.Api.Organizations, for example:
  #
  #   test "lists things", %{bypass: bypass, conn: conn} do
  #     MockServer.expect_get(bypass, "/things", 200, %{things: []})
  #     assert {:ok, _response} = Organizations.list_things(conn)
  #   end

  test "module is generated and loaded" do
    assert Code.ensure_loaded?(Organizations)
  end
end
