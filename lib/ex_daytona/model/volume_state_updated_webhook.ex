...
defmodule ExDaytona.Model.VolumeStateUpdatedWebhook do
  @moduledoc """
  VolumeStateUpdatedWebhook model.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :id => String.t(),
          :name => String.t(),
          :newState => ExDaytona.Model.VolumeState.t(),
          :oldState => ExDaytona.Model.VolumeState.t(),
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(:newState, :struct, ExDaytona.Model.VolumeState)
    |> Deserializer.deserialize(:oldState, :struct, ExDaytona.Model.VolumeState)
  end
end
