...
defmodule ExDaytona.Model.GpuCapacityResponse do
  @moduledoc """
  GpuCapacityResponse model.
  """
  ...
  @type t :: %__MODULE__{
          :capacity => [ExDaytona.Model.GpuCapacity.t()],
  ...
  def decode(value) do
    value
    |> Deserializer.deserialize(:capacity, :list, ExDaytona.Model.GpuCapacity)
  end
end
