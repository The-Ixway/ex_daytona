...
defmodule ExDaytona.Model.MetricSeries do
  @moduledoc """
  MetricSeries model.
  """
  ...
  @type t :: %__MODULE__{
          :dataPoints => [ExDaytona.Model.MetricDataPoint.t()],
          :metricName => String.t()
        }
  ...
  def decode(value) do
    value
    |> Deserializer.deserialize(:dataPoints, :list, ExDaytona.Model.MetricDataPoint)
  end
end
