...
defmodule ExDaytona.Model.AccessibilityNodesResponse do
  @moduledoc """
  AccessibilityNodesResponse model.
  """
  ...
  @type t :: %__MODULE__{
          :matches => [ExDaytona.Model.ComputeruseAccessibilityNode.t()] | nil,
  ...
  def decode(value) do
    value
    |> Deserializer.deserialize(:matches, :list, ExDaytona.Model.ComputeruseAccessibilityNode)
  end
end
