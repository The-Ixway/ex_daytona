...
defmodule ExDaytona.Model.PtyListResponse do
  @moduledoc """
  PtyListResponse model.
  """
  ...
  @type t :: %__MODULE__{
          :sessions => [ExDaytona.Model.PtySessionInfo.t()]
        }
  ...
  def decode(value) do
    value
    |> Deserializer.deserialize(:sessions, :list, ExDaytona.Model.PtySessionInfo)
  end
end
