...
defmodule ExDaytona.Model.SandboxStateUpdatedWebhook do
  @moduledoc """
  SandboxStateUpdatedWebhook model.
  """
  ...
  @type t :: %__MODULE__{
          ...
          :id => String.t(),
          :newState => ExDaytona.Model.SandboxState.t(),
          :oldState => ExDaytona.Model.SandboxState.t(),
  ...
  def decode(value) do
    ...
    |> Deserializer.deserialize(:newState, :struct, ExDaytona.Model.SandboxState)
    |> Deserializer.deserialize(:oldState, :struct, ExDaytona.Model.SandboxState)
  end
end
