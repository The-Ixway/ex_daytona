...
defmodule ExDaytona.Model.GenerateWorkosAdminPortalLink do
  @moduledoc """
  GenerateWorkosAdminPortalLink model.
  """
  ...
  @type t :: %__MODULE__{
          :intent => ExDaytona.Model.WorkosAdminPortalIntent.t()
        }
  ...
  def decode(value) do
    value
    |> Deserializer.deserialize(:intent, :struct, ExDaytona.Model.WorkosAdminPortalIntent)
  end
end
