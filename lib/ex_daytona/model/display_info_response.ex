...
defmodule ExDaytona.Model.DisplayInfoResponse do
  @moduledoc """
  DisplayInfoResponse model.
  """
  ...
  @type t :: %__MODULE__{
          :displays => [ExDaytona.Model.DisplayInfo.t()] | nil
        }
  ...
  def decode(value) do
    value
    |> Deserializer.deserialize(:displays, :list, ExDaytona.Model.DisplayInfo)
  end
end
