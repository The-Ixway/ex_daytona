...
defmodule ExDaytona.Model.SnapshotStateUpdatedWebhook do
  @moduledoc """
  SnapshotStateUpdatedWebhook model.
  """
  ...
  @type t :: %__MODULE__{
          :event => ExDaytona.Model.WebhookEvent.t(),
          :id => String.t(),
          :name => String.t(),
          :newState => ExDaytona.Model.SnapshotState.t(),
          :oldState => ExDaytona.Model.SnapshotState.t(),
  ...
  def decode(value) do
    value
    |> Deserializer.deserialize(:event, :struct, ExDaytona.Model.WebhookEvent)
    |> Deserializer.deserialize(:newState, :struct, ExDaytona.Model.SnapshotState)
    |> Deserializer.deserialize(:oldState, :struct, ExDaytona.Model.SnapshotState)
  end
end
